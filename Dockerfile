...
COPY files/custom-services.d/safedesk-thorium-chrome-seed /custom-services.d/safedesk-thorium-chrome-seed
RUN chmod +x /custom-cont-init.d/safedesk-thorium-flags
RUN chmod +x /custom-services.d/safedesk-thorium-chrome-seed
