...
COPY files/custom-cont-init.d/safedesk-thorium-chrome-seed /custom-cont-init.d/safedesk-thorium-chrome-seed
RUN chmod +x /custom-cont-init.d/safedesk-thorium-flags
RUN chmod +x /custom-cont-init.d/safedesk-thorium-chrome-seed
